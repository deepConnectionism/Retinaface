...
This repo addresses some of the ONNX export issues in Pytorch Retinaface.
...
year={2019}
```
Modification steps reference: [Retinaface ONNX 如何正确导出](https://www.cnblogs.com/odesey/p/16657935.html)